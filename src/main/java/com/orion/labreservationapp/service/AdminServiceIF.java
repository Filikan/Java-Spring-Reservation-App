...
public interface AdminServiceIF {
    ...
    public void createServer(String server_name, String server_location, String server_ip, String serial_number,
            String server_type, Boolean is_host, int id) throws SQLException;
